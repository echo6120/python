...
class ParseExcel(object):
    ...
    def get_row_data(self,case_id):
        ...
        rows_data = self.get_single_row(row_num)
        return rows_data
...
if __name__=='__main__':
    ...
    pe.set_sheet_by_name("163账号".decode("gbk"))
    print pe.get_default_name()
    print pe.get_sheet_by_name("163账号").decode("gbk")
    ...
    print pe.get_cell_content(8, 8)'''
    #print pe.get_row_num("Imooc-11")
    for i in  pe.get_row_data("Imooc-11"):
        print i.value